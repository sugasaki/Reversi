    ...
    public class Board_ViewModel : ViewModelBase
    {
        ...
        public void Reflesh()
        {
            foreach (var item in SquareList)
            {
                ...
                if (color == Reversi.Engine.Disc.EMPTY) { item.BlackVisibility = System.Windows.Visibility.Hidden; item.WhiteVisibility = System.Windows.Visibility.Hidden; }
                if (color == Reversi.Engine.Disc.BLACK) { item.BlackVisibility = System.Windows.Visibility.Visible; item.WhiteVisibility = System.Windows.Visibility.Hidden; }
                if (color == Reversi.Engine.Disc.WHITE) { item.BlackVisibility = System.Windows.Visibility.Hidden; item.WhiteVisibility = System.Windows.Visibility.Visible; }
